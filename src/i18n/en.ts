...
export const en = {
  ...
  deal: {
    ...
    calculatorHint: {
      one: "Enter the chip count of the player left. The remaining places pay {total}.",
      other: "Enter the chip count of the {count} players left. The remaining places pay {total}."
    },
    chips: "Chips",
    chipsOf: "Chips of {name}",
    chipsInPlay: "{entered} of {inPlay} in play",
    icm: "ICM",
    chipChop: "Chip chop",
    difference: "ICM − chip chop",
    total: "Total",
    playFor: "Left to play for",
    playForHint: "Optional: kept from the first prize for the winner.",
    enterChips: "Enter every chip count to see the proposals.",
    prerequisites: "Before recording",
    prerequisitesHint: "A deal shares amounts that can no longer move.",
    registrationOpen: "Registration is open: no entry can arrive after a deal.",
    registrationClosed: "Registration is closed.",
    payoutsUnlocked: "Payouts are not locked yet.",
    payoutsStale: "The locked payouts no longer match the prize pool.",
    payoutsLocked: "Payouts are locked.",
    record: "Record the deal",
    kind: "Deal on",
    recordAction: "Record this deal",
    notReady: "Close registration and lock the payouts first.",
    notLocked: "Lock the payouts first.",
    notClosed: "Close registration first.",
    confirmIcm: "Record the ICM deal?",
    confirmChipChop: "Record the chip-chop deal?",
    confirmPlayFor: "{amount} is left to play for, on top of the winner's share. Each player's prize becomes the amount above; the tournament goes on.",
    confirmNoPlayFor: "Each player's prize becomes the amount above; the tournament goes on. Undo the deal from the header to change it.",
    recordedTitle: "Deal",
    recordedHint: "These prizes are the agreed amounts; the winner also takes what is left to play for. Undo the deal from the header to change it.",
