import { createTournament, dismissToasts, errorToast, expect, openTab, registerAll, startClock, test, toasts } from "./support";
...
test("changes the structure during play", async ({ page }) => {
  ...
  // The notification sits over the action bar.
